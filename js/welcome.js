...
$.ajax({
    ...
    data: {
        key: 'BSKBZ-JOTHL-IYPP5-MRH6M-UEW6E-O7FAR',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(106.72707, 35.53508, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
